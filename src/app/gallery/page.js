...
export const metadata = {
    title: 'Gallery | SJ Arts Printers',
    description: 'Our work — signage, branding and printing projects across Punjab.',
}
    ...
    return (
        <main className={styles.page}>
            <div className={styles.banner}>
                ...
                {/* 3D carousel — exactly like your HTML */}
                <div
                ...
                {/* bottom content — logo watermark + stats */}
